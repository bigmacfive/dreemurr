<script setup>
import { reactive, computed, onMounted, onBeforeUnmount, onUnmounted, watch, ref, toRef, nextTick } from 'vue'
...
const { stickyState, initStickToCursor, stickToCursor, unstickToCursor, clearStickyPositionOffsets } = useStickyCard({
...
.card-wrap(
  ...
  :data-sticky-stretch-resistance="stickyState.stickyStretchResistance"
  :data-x="x"
  :data-y="y"
