...
Because dreemurr is an extremely small, [non-VC funded organic business](https://pketh.org/organic-software.html) right now that is still finding sustainability, so the bug bounties payouts to white hat reporters I can offer at this time are relatively limited.
...
I only do payouts to bank accounts via wise, or paypal (no crypto).

Instead of cash, successful reporters can choose to apply the 50% academic discount to their dreemurr account as their reward.

You can report bugs to [security@kinopio.club](mailto:security@kinopio.club)
